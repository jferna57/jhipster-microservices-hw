...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "barService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "barService API";

        private String description = "barService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "barService";
