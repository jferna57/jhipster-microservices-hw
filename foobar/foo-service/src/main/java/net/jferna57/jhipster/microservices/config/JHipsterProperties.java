...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "fooService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "fooService API";

        private String description = "fooService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "fooService";
