...
import net.jferna57.jhipster.microservices.config.Constants;
import com.codahale.metrics.annotation.Timed;
import net.jferna57.jhipster.microservices.domain.User;
import net.jferna57.jhipster.microservices.repository.UserRepository;
import net.jferna57.jhipster.microservices.security.AuthoritiesConstants;
import net.jferna57.jhipster.microservices.service.MailService;
import net.jferna57.jhipster.microservices.service.UserService;
import net.jferna57.jhipster.microservices.web.rest.vm.ManagedUserVM;
import net.jferna57.jhipster.microservices.web.rest.util.HeaderUtil;
import net.jferna57.jhipster.microservices.web.rest.util.PaginationUtil;
